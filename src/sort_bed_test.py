...
cmd3 = 'echo "" > data/test-sorted-2.bed'
cmd4 = 'python3.10 src/sort_bed.py data/large.bed data/test-sorted-2.bed'
os.system(cmd3)
os.system(cmd4)

def test_sort_bed_2(): 
    result = cmp('data/test-sorted-2.bed', 'data/large-sorted.bed', shallow=True)
    assert result
